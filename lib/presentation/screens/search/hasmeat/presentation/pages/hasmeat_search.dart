...
import '../controllers/hasmeat_search_controller.dart';

class HasmeatSearch extends StatelessWidget {
  const HasmeatSearch({super.key});

  @override
  Widget build(BuildContext context) {
    HasmeatSearchController controller = Get.put(HasmeatSearchController())   ;
