...
import '../controllers/intedab_search_controller.dart';

class IntedabSearch extends StatelessWidget {
  const IntedabSearch({super.key});

  @override
  Widget build(BuildContext context) {
    IntedabSearchController controller = Get.put(IntedabSearchController());
                  ...
                  Column(
                    children: [
                      ...
                      CustomTextField(
                          ...
                          customWidth: 300),
                      CustomTextField(
                          controller: controller.jihaIntedab,
                          label: 'جهة الانتداب',
                          customHeight: 35,
                          customWidth: 300),
                    ],
