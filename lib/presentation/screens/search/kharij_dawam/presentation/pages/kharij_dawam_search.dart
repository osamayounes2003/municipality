...
import 'package:municipality/presentation/screens/search/kharij_dawam/presentation/controllers/kharij_dawam_search_controller.dart';
...
class KharijDawamSearch extends StatelessWidget {
  const KharijDawamSearch({super.key});

  @override
  Widget build(BuildContext context) {
    KharijDawamSearchController controller =
        Get.put(KharijDawamSearchController());
