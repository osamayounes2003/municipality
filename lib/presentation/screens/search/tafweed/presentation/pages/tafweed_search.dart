...
import 'package:municipality/presentation/screens/search/tafweed/presentation/controllers/tafweed_search_controller.dart';
...
class TafweedSearch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TafweedSearchController controller = Get.put(TafweedSearchController());
