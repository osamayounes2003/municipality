...
import 'package:municipality/presentation/screens/search/dissents/presentation/controllers/dissents_search_controller.dart';
import 'package:municipality/presentation/screens/search/end_service/presentation/controllers/end_service_search_controller.dart';
...
class EndServiceSearch extends StatelessWidget {
  const EndServiceSearch({super.key});

  @override
  Widget build(BuildContext context) {
    EndServiceController controller = Get.put(EndServiceController());
