...
import 'package:municipality/presentation/screens/search/dawrat/presentation/controllers/dawrat_search_controller.dart';
...
class DawratSearch extends StatelessWidget {
  const DawratSearch({super.key});

  @override
  Widget build(BuildContext context) {
    DawratSearchController controller = Get.put(DawratSearchController());
                    ...
                    children: [
                      CustomTextField(
                        controller: controller.name,
                          label: 'الاسم', customHeight: 35, customWidth: 300),
                      CustomTextField(
