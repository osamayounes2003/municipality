...
import 'package:municipality/presentation/screens/search/ijazat/presentation/controllers/ijazat_search_controller.dart';
...
class IjazatSearch extends StatelessWidget {
  IjazatSearch({super.key});

  @override
  Widget build(BuildContext context) {
    IjazatSearchController controller = Get.put(IjazatSearchController());
                  ...
                  Column(
                    children: [
                      ...
                      CustomTextField(
                          ...
                          customWidth: 300),
                      CustomTextField(
                          controller: controller.ijazehType,
                          label: 'نوع الإجازة',
                          customHeight: 35,
                          customWidth: 300),
                    ],
