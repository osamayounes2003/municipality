...
class QararMobasharahSearch extends StatelessWidget {
  const QararMobasharahSearch({super.key});

  @override
  Widget build(BuildContext context) {
    QararMobasharahController controller = Get.put(QararMobasharahController());
